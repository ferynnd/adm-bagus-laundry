...
import dev.ferynnd.admbaguslaundry.controller.ClientAdapter
...
import dev.ferynnd.admbaguslaundry.databinding.FragmentAdminListClientBinding
    ...
    override fun onCreateView(
        ...
        binding.searchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
            ...
            override fun onQueryTextChange(newText: String?): Boolean {
                clientViewModel.onSearchQueryChanged(newText.orEmpty())
                return true
            }
        })
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            ...
            clientViewModel.pagination.observe(viewLifecycleOwner) { pagination ->
        ...
        binding.btnPrevPage.setOnClickListener {
            if (currentPage > 1) {
                clientViewModel.getClient(currentPage - 1)
            }
        }
